...
class Settings(BaseSettings):
    ...
    openai_model: Annotated[str, Field(default="gpt-5.1")]

    zalo_access_token: Annotated[str, Field(default="")]
    zalo_group_name: Annotated[str, Field(default="MAXFLOW - Lễ tân")]
